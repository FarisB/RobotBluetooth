...
import com.robot.lionete.robot.exceptions.BTAdapterDisabledHException;
import com.robot.lionete.robot.exceptions.BTHandlingException;
import com.robot.lionete.robot.exceptions.NoAdapterBTHException;
import com.robot.lionete.robot.exceptions.NoBTDeviceFoundException;
...
public class BTConnectionHandler {
    ...
    */
   public void connectToBTDevice(String pDeviceName) throws BTHandlingException, IOException, NoBTDeviceFoundException {
         checkBTAdapter();
